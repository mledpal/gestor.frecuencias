        ...
        <section className={className}>
            ...
            >
                <div>
                    ...
                    <TextInput
                        id="name"
                        className="mt-1 block w-full  text-white bg-slate-800 dark:text-gray-300 dark:bg-black"
                        value={data.nombre}
                ...
                {mustVerifyEmail && user.email_verified_at === null && (
                    <div>
                        <p className="text-sm mt-2 text-white bg-slate-800 dark:text-gray-300 dark:bg-black">
