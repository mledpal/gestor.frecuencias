    ...
    return (
        <div className="flex flex-col items-center justify-between gap-2 w-full h-full">
            ...
            <main className="h-full w-full grid grid-cols-2 place-items-center gap-0">
                <div className={cssButtons} onClick={() => handleOpen("lg")}>
                    <i className={`fa-solid fa-circle-plus ${cssIcons}`}></i>
                ...
                <div className={cssButtons}>
                    <i className={`fa-solid fa-address-book ${cssIcons}`}></i>
                    <span>Lista de Amigos</span>
                </div>
                <div className={cssButtons}>
                    <i className={`fa-solid fa-file-import  ${cssIcons}`}></i>
                    <span>Importar Contactos</span>
                </div>
                <div className={cssButtons}>
                    <i className={`fa-solid fa-file-export ${cssIcons}`}></i>
